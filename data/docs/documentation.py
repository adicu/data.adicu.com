lead = """Documentation for the set of Data API's provided by,
                ...
                around there! If you have any setbacks, feel free to ping
                infrastructure@adicu.com and we'll get back to you as quick as we can.
                Please keep in mind this is API version 0.1 and is pretty
